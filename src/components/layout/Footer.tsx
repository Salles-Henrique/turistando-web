    ...
    <footer className="bg-gray-900 text-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-12">
          {/* Brand */}
          <div>
            <p className="font-bold text-white text-xl mb-6 tracking-tight">Turistando</p>
          ...
          {/* Explorar */}
          <div>
            <h3 className="font-semibold text-white mb-6 text-sm uppercase tracking-wider">Explorar</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/trips" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                  Todas as Viagens
                </Link>
              </li>
              <li>
                <Link href="/destinations" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                  Destinos
                </Link>
              </li>
              <li>
                <Link href="/guides" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                  Guias de Viagem
                </Link>
              </li>
            </ul>
          ...
          {/* Suporte */}
          <div>
            <h3 className="font-semibold text-white mb-6 text-sm uppercase tracking-wider">Suporte</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/help" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                  Centro de Ajuda
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/cookies" className="text-sm text-gray-400 hover:text-white transition-colors duration-300">
                  Política de Cookies
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8">
              <a href="https://www.linkedin.com/in/seduza-cosm%C3%A9ticos-ab072b373/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
              ...
              <a href="https://www.instagram.com/turistandooficial_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
